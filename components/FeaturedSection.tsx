    ...
    <section className="bg-[#0a0a0a] px-4 xl:px-20 2xl:px-32 py-16">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        {projects.map((project, index) => (
          <Card
            key={index}
            className="pt-0 overflow-hidden group transition-all hover:shadow-lg bg-transparent text-white border-neutral-600"
          >
            ...
            <CardContent>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="inline-flex items-center rounded-full bg-neutral-600 px-2.5 py-0.5 text-xs text-white"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="mt-6 flex gap-4">
                <Button
                  ...
                  size="sm"
                  variant="outline"
                  className="bg-transparent border-neutral-600"
                >
                  <Link
